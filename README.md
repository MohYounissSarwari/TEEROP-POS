...
- **Backend (Render):** _Add your Render URL after deployment_
...
| Role | Email | Password |
|------|-------|----------|
| Admin | admin@teerop.com | Admin1234 |
| Inventory Manager | manager@teerop.com | 123456 |
| Cashier | cashier@teerop.com | 123456 |
...
3. Set environment variables in Render dashboard (same as `server/.env`)

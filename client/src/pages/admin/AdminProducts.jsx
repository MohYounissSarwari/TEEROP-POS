        ...
        <Modal title={editingProduct ? 'Edit Product' : 'Add Product'} onClose={() => setShowProductModal(false)}>
          <form onSubmit={handleProductSubmit} className="space-y-4">
            ...
            <div className="flex justify-end gap-3 pt-2">
              <button type="button" onClick={() => setShowProductModal(false)} className="px-4 py-2 text-sm text-slate-600 border border-slate-300 rounded-lg hover:bg-slate-50">
                Cancel
              </button>
        ...
        <Modal title="Deactivate Product" onClose={() => setDeactivateModal(null)}>
          <div className="space-y-4">
            <p className="text-sm text-slate-700">
              Are you sure you want to deactivate <strong>{deactivateModal.name}</strong>? It will no longer be available for sale.
            </p>
            <div className="flex justify-end gap-3">
